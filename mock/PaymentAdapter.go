...
import "ApiRest/app/model/billing"
...
func (m *MockPaymentAdapaterUseCase) CreateCustomer(params billing.CustomerParams) (string, error) {
	m.ctrl.T.Helper()
...
func (r *FakePayment) CreateCustomer(params billing.CustomerParams) (string, error) {
	return "fake", nil
}

// Pay from email to email this amount
func (b *FakeAdapter) CreateCustomer(params billing.CustomerParams) (string, error) {
